...
export default function Portfolio() {
    return (
        <div className="relative bg-[#000e2f] py-24 sm:py-32 text-white">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 z-40">
                ...
                <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    <CardPortfolio link="/portfolio" source="/portfolio-logo-0.png" alt="Logo" />
                    <CardPortfolio link="/portfolio" source="/portfolio-logo-2.png" alt="Logo"/>
                    <CardPortfolio link="/portfolio" source="/portfolio-logo-3.png" alt="Logo"/>
                </div>
            </div>
            <div
                    aria-hidden="true"
