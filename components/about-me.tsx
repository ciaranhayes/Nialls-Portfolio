...
export default function AboutMe() {
    return (
        <div id="aboutme" className="relative isolate overflow-hidden bg-[#000e2f] px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0 text-white">
            <div
                aria-hidden="true"
                className="absolute inset-x-0 inset-x-0 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
            >
                <div
                    style={{
                        clipPath:
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                ...
                <div className="-mt-12 -ml-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                    <Image src="/niall-headshot-2.png" alt="picture of Niall Blackwell" width={1080}
